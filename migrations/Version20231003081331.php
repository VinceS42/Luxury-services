 ...
 */
final class Version20231003081331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job ADD job_type_id INT NOT NULL, DROP type_offer');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE job ADD type_offer VARCHAR(255) NOT NULL, DROP job_type_id');
    }
}
